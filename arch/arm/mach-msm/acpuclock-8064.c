...
static struct l2_level l2_freq_tbl_lightningzap[] __initdata = {
	[0]  = { {  384000, PLL_8, 0, 0x00 },  950000, 1050000, 1 },
	[1]  = { {  432000, HFPLL, 2, 0x20 }, 1050000, 1050000, 2 },
	[2]  = { {  486000, HFPLL, 2, 0x24 }, 1050000, 1050000, 2 },
	[3]  = { {  540000, HFPLL, 2, 0x28 }, 1050000, 1050000, 2 },
...
static struct acpu_level tbl_slow[] __initdata = {
	...
	{ 1, {    94500, HFPLL, 2, 0x07 }, L2(0),   700000 },
	{ 1, {   189000, HFPLL, 2, 0x0E }, L2(0),   750000 },
	{ 1, {   243000, HFPLL, 2, 0x12 }, L2(0),   800000 },
#endif
...
static int __init acpuclk_8064_probe(struct platform_device *pdev)
{
	...
	if (opt_bin == 1) {
		acpuclk_8064_params.l2_freq_tbl = l2_freq_tbl_lightningzap;
		acpuclk_8064_params.l2_freq_tbl_size = sizeof(l2_freq_tbl_lightningzap);
	}
