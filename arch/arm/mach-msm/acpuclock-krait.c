...
static int __init cpufreq_read_arg_max_oc0(char *max_oc0)
{
	...
	if (err) {
		arg_max_oc0 = 1836000;
		printk(KERN_INFO "[lightningzap]: max_oc0='%i'\n", arg_max_oc0);
		return 1;
	}
...
static int __init cpufreq_read_arg_max_oc1(char *max_oc1)
{
	...
	if (err) {
		arg_max_oc1 = 1836000;
		printk(KERN_INFO "[lightningzap]: max_oc1='%i'\n", arg_max_oc1);
		return 1;
	}
...
static int __init cpufreq_read_arg_max_oc2(char *max_oc2)
{
	...
	if (err) {
		arg_max_oc2 = 1836000;
		printk(KERN_INFO "[lightningzap]: max_oc2='%i'\n", arg_max_oc2);
		return 1;
	}
...
static int __init cpufreq_read_arg_max_oc3(char *max_oc3)
{
	...
	if (err) {
		arg_max_oc3 = 1836000;
		printk(KERN_INFO "[lightningzap]: max_oc3='%i'\n", arg_max_oc3);
		return 1;
	}
